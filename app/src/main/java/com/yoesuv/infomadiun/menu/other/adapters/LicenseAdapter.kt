...
class LicenseAdapter : ListAdapter<LicenseModel, LicenseViewHolder>(AdapterCallback.diffLicenseCallback) {
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int,
    ): LicenseViewHolder = LicenseViewHolder.from(parent)

    override fun onBindViewHolder(
        holder: LicenseViewHolder,
        position: Int,
    ) {
