...
class ChildFragmentLibrariesViewModel : ViewModel() {
    ...
    fun setupData(context: Context?) {
        ...
        val gson =
            LicenseModel(
                context?.getString(R.string.gson),
                context?.getString(R.string.gson_url),
                context?.getString(R.string.gson_license),
                false,
            )
        val dexcount =
            LicenseModel(
                context?.getString(R.string.dexcount),
                context?.getString(R.string.dexcount_url),
                context?.getString(R.string.dexcount_license),
                false,
            )
